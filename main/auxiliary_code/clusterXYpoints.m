...
%
%% Code
function [clustersCentroids,clustersGeoMedians,clustersXY,C] = clusterXYpoints(inputfile,maxdist,minClusterSize,method,mergeflag)
...
C = zeros(size(inputfile,1),1);
for iclus = 1:clusterCount
    C(clusters{iclus,1})=iclus;
end
